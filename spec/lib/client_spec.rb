...
describe GContacts::Client do
  ...
  context 'client' do
    it 'should send the correct request when updating an image' do
      ...
      element = GContacts::Element.new(
        Nori.new(parser: :nokogiri).parse(
      ...
      mock_response('') do |http_mock, res_mock|
        ...
        http_mock.should_receive(:request_put)
                 .with(
  ...
  it 'should detect a wrong auth token' do
    mock_response('') do |http_mock, res_mock|
      ...
      http_mock.should_receive(:request_get)
               .with(
  ...
  context 'contact' do
    it 'loads all' do
      ...
      contact.data.should ==   { 'gd:name' => [{ 'gd:fullName' => 'Steve Stephson', 'gd:givenName' => 'Steve', 'gd:familyName' => 'Stephson' }], 'gd:email' => [{ '@rel' => 'http://schemas.google.com/g/2005#other', '@address' => 'steve.stephson@gmail.com', '@primary' => 'true' }, { '@rel' => 'http://schemas.google.com/g/2005#other', '@address' => 'steve@gmail.com' }], 'gd:phoneNumber' => [{ 'text' => '3005004000', '@rel' => 'http://schemas.google.com/g/2005#mobile' }, { 'text' => '+130020003000', '@rel' => 'http://schemas.google.com/g/2005#work' }, { 'text' => '+130020003111', '@rel' => 'http://schemas.google.com/g/2005#home_fax' }], 'gContact:groupMembershipInfo' => [{ '@deleted' => 'false', '@href' => 'http://www.google.com/m8/feeds/groups/john.doe%40gmail.com/base/6' }] }
      contact.emails.should == [{ 'address' => 'steve.stephson@gmail.com', 'type' => 'other' }, { 'address' => 'steve@gmail.com', 'type' => 'other' }]
      contact.phones.should == [{ 'text' => '+130020003000', '@rel' => 'work' }]
      contact.mobiles.should == [{ 'text' => '3005004000', '@rel' => 'mobile' }]
      contact.fax_numbers.should == [{ 'text' => '+130020003111', '@rel' => 'home fax' }]
      ...
      contact.emails.should == [{ 'address' => 'dave.pratchett@gmail.com', 'type' => 'home' }]
      contact.phones.should == []
      contact.mobiles.should == [{ '@rel' => 'mobile', 'text' => '7003002000' }]
