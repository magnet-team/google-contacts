...
describe GContacts::Element do
  ...
  context 'Check hashed attributes' do
    ...
    it '#hashed_addresses' do
      element.hashed_addresses.should == { 'home' => [{ address: "Xolo\n      Dome\n      Krypton", address_line: 'Xolo', geo_city: 'Dome', geo_state: 'Krypton', zipcode: nil, country: 'USA', address_line_2: nil, address_line_3: nil }],
                                           'work' => [{ address: "Nokia Lumia 720\n      Finland\n      Earth", address_line: 'Nokia Limia 720', geo_city: 'Finland', geo_state: 'Earth', zipcode: nil, country: nil, address_line_2: nil, address_line_3: nil }] }
    end
  ...
  context 'Other attributes' do
    ...
    context '#birthday' do
      it 'GContacts::Element should have method called birthday' do
        -> { element.birthday }.should_not raise_error
      end
    ...
    context '#organization' do
      ...
      it 'GContacts::Element should have method called organization' do
        -> { entry.organization }.should_not raise_error
      end
    ...
    context '#org_name' do
      ...
      it 'GContacts::Element should have method called org_name' do
        -> { entry.org_name }.should_not raise_error
      end
    ...
    context '#org_title' do
      ...
      it 'GContacts::Element should have method called org_title' do
        -> { entry.org_title }.should_not raise_error
      end
    ...
    context '#websites' do
      it 'GContacts::Element should have method called websites' do
        -> { element.websites }.should_not raise_error
      end
